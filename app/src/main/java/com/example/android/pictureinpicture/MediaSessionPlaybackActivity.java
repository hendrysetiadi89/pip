...
public class MediaSessionPlaybackActivity extends BaseActivity {
    ...
    private boolean flagGoToActivity3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.minimize_and_start).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                minimize();
                flagGoToActivity3 = true;
            }
        });
    }
    ...
    public void onPictureInPictureModeChanged(
        ...
        if (!isInPictureInPictureMode) {
            ...
            if (flagGoToActivity3) {
                Intent insideIntent = new Intent(getApplicationContext(), TigaActivity.class);
                Intent intent = new Intent("startact");
                intent.putExtra("extra_intent", insideIntent);
                LocalBroadcastManager.getInstance(this).sendBroadcast(intent);

                flagGoToActivity3 = false;
            }
        }
    }
